...
\end{center}
\begin{abstract}
Multiple numeric and analytical techniques were used to investigate the high energy states of a Cooper Pair Box based on a Josephson Junction. It is found that for high states the system behaves like a charge state. Several methods are implemented, particularly those from Koch and Cottet. These methods are compared and the validity of the results is discussed.
\end{abstract}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.7\linewidth]{C:/Users/Louise/Documents/project/final_project/figs/josephsonjunction.png}
\caption{magic}
\label{fig:picture1}
\end{figure}
